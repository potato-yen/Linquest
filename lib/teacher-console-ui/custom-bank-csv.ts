...
// Territory challenges can require up to 18 questions (reverse 3x);
// we set min to 18 to ensure the bank can fill the largest challenge.
export const MIN_TOTAL_QUESTIONS = 18;
