...
revoke all on function public.get_activity_dashboard(uuid) from public;
grant execute on function public.get_activity_dashboard(uuid) to authenticated, service_role;
