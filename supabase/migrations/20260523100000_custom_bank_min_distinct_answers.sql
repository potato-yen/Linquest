-- Tighten custom-bank creation guard so territory/battle challenge specs
-- cannot be underfilled by tiny banks.
--
-- Keep this in backend, even though the frontend already validates it, so
-- direct RPC calls cannot bypass the rule.
